      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-card rounded-xl border shadow-sm p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input defaultValue="Smayen Abir" className="w-full px-3 py-2.5 rounded-lg border bg-background text-sm focus:outline-none focus:ring-2 focus:ring-primary/20" />
            </div>
            <div>
              <label className="block text-sm font-medium text-foreground mb-1.5">Email</label>
              <input defaultValue="stagiaire@leoni.com" disabled className="w-full px-3 py-2.5 rounded-lg border bg-background text-sm focus:outline-none focus:ring-2 focus:ring-primary/20" />
            </div>
        ...
        <div className="bg-card rounded-xl border shadow-sm p-6">
          ...
          <div className="space-y-3">
            {["Submission feedback", "Event reminders", "Certificate available", "Attendance alerts"].map(item => (
...
export default StagiaireSettings;
