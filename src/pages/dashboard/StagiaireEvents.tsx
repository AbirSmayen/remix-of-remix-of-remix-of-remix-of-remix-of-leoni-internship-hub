...
import { Calendar as CalIcon, MapPin, Clock, Users, ChevronLeft, ChevronRight, Search } from "lucide-react";
  ...
  return (
    <DashboardLayout role="stagiaire">
      ...
      <div className="mb-6">
        ...
        <p className="text-muted-foreground text-sm mt-1">View upcoming events and confirm your attendance.</p>
      </div>
                ...
                return (
                  <div key={event.id} className="p-4 hover:bg-secondary/20 transition-colors">
                    ...
                    <button
                      ...
                      className="mt-3 w-full py-2 bg-primary text-primary-foreground rounded-lg text-xs font-semibold hover:bg-primary/90 transition-all"
                    >
                      Confirm Attendance
                    </button>
                  </div>
...
export default StagiaireEvents;
